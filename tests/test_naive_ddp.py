...
def _test_NaiveDDP(rank: int, world_size: int, model_class: Type[torch.nn.Module]):
    ...
    ddp_model = get_ddp_naive(ddp_base)
    ...
    for i in range(5):
        ...
        ddp_naive_on_after_backward(ddp_model, ddp_optimizer)
